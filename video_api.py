...
def test2():
    ...
    text_to_return = 'TEST OK: Integration test - Value of Video ID: ' + \
        str(req_id) + 'my data:' + data
...
def youtube_publish():
    ...
    video_processing_result = my_client.update_video_status(
        video_data, video_processing_result)
